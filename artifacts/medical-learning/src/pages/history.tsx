    ...
    <Layout>
      <div className="p-8 h-full flex flex-col bg-slate-50/50">
        <header className="mb-8">
          <h1 className="text-3xl font-display font-bold text-foreground">AI History</h1>
          <p className="text-muted-foreground mt-1">Log of your clinical intelligence interactions</p>
        </header>
        ...
        {isLoading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center pb-20">
            ...
            <h3 className="text-2xl font-display font-bold text-foreground">No history</h3>
            <p className="text-muted-foreground mt-2 max-w-md">Your interactions with the AI assistant will appear here.</p>
          </div>
        ) : (
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        <Badge variant="purple" className="flex items-center gap-1.5 shadow-sm">
                          <Brain className="w-3 h-3" /> {entry.action.toUpperCase()}
                        </Badge>
